...
# Modified to exclude 'disgust' emotion (6 emotions total)
# ============================================================================
...
print("=" * 70)
print("EMOTION DETECTION - DATA LOADER IMPLEMENTATION (6 EMOTIONS)")
print("=" * 70)
...
class EmotionDataset(Dataset):
    ...
    Args:
        ...
        exclude_classes: List of emotion classes to exclude (e.g., ['disgust'])
    """
    ...
    def get_class_counts(self):
        ...
        return [counts.get(i, 0) for i in range(len(self.classes))]
...
EXCLUDE_EMOTIONS = ['disgust']  # Emotions to exclude
...
# CREATE DATASETS
# ============================================================================
print(f"\nExcluding emotions: {EXCLUDE_EMOTIONS}")
...
fig.suptitle('Sample Training Batch (48x48 grayscale, 6 emotions)', fontsize=14, fontweight='bold')
...
print(f"  • Excluded emotions: {EXCLUDE_EMOTIONS}")
...
print("\n" + "=" * 70)
print("READY FOR TRAINING WITH 6 EMOTIONS")
print("=" * 70)