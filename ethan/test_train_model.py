# ============================================================================
# 4_train_model.py - Model Training (48x48 grayscale, 6 emotions)
# Modified to exclude 'disgust' emotion
# ============================================================================
...
# ============================================================================
# CUSTOM CNN MODEL FOR 48x48 GRAYSCALE IMAGES (6 EMOTIONS)
# ============================================================================
class EmotionCNN(nn.Module):
    """
    Custom CNN architecture designed for 48x48 grayscale emotion detection
    Modified for 6 emotion classes (excluding disgust)
    """
...
print("=" * 70)
print("EMOTION DETECTION - MODEL TRAINING (6 EMOTIONS)")
print("=" * 70)

# ============================================================================
# CONFIGURATION
# ============================================================================
EXCLUDE_EMOTIONS = ['disgusted']  # Emotions to exclude
...
# Create datasets - excluding disgust
train_dataset = EmotionDataset('prepared_data/train', 
                               transform=train_transform,
                               exclude_classes=EXCLUDE_EMOTIONS)
val_dataset = EmotionDataset('prepared_data/val', 
                             transform=val_test_transform,
                             exclude_classes=EXCLUDE_EMOTIONS)
test_dataset = EmotionDataset('prepared_data/test', 
                              transform=val_test_transform,
                              exclude_classes=EXCLUDE_EMOTIONS)
...
for epoch in range(CONFIG['num_epochs']):
    ...
    if val_acc > best_val_acc:
        ...
        best_model_path = os.path.join(CONFIG['save_dir'], 'best_model_6class.pth')
        torch.save({
            'epoch': epoch,
...
# Save final model
final_model_path = os.path.join(CONFIG['save_dir'], 'final_model_6class.pth')
...
# Load best model
checkpoint = torch.load(os.path.join(CONFIG['save_dir'], 'best_model_6class.pth'))
...
# ============================================================================
history_path = os.path.join(CONFIG['log_dir'], 'training_history_6class.json')
...
axes[0].set_title('Training and Validation Loss (6 Emotions)', fontsize=14, fontweight='bold')
...
axes[1].set_title('Training and Validation Accuracy (6 Emotions)', fontsize=14, fontweight='bold')
axes[1].legend(fontsize=10)
axes[1].grid(True, alpha=0.3)

plt.tight_layout()
plot_path = os.path.join(CONFIG['log_dir'], 'training_curves_6class.png')
...
summary_path = os.path.join(CONFIG['log_dir'], 'training_summary_6class.json')
